		...
		for(var i = 0; i < treeData.length; i++) {
			...
			var cp = {
				...
				headerCfg: {
			        ...
			        cls: 'x-panel-header',
			        children: [
			        	{tag: 'div', cls: 'panel_header_icon_title_left', html: '<img width="20" height="20" src="'+treeData[i].icon+'" />'},
			            { tag: 'div', cls: 'panel_header_main', 'html': '<b style="font-size:14px;">'+treeData[i].menuName + '</b>' }
			        ]
			    },
				layout : "fit",
				items: [
