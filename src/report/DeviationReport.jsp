	...
	<body>
		...
		<div class="doc">
			...
			<table border="0" class="myTable">
				...
				<tr>
					<td>结果</td>
					<td><c:if test="${fn:length(o.sampleList) > 0}"><c:if test="${o.sampleList[0].result1Type==0}">${o.sampleList[0].result1_str}</c:if><c:if test="${o.sampleList[0].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[0].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[0].doubleTmer == true}">(${o.sampleList[0].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 1}"><c:if test="${o.sampleList[1].result1Type==0}">${o.sampleList[1].result1_str}</c:if><c:if test="${o.sampleList[1].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[1].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[1].doubleTmer == true}">(${o.sampleList[1].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 2}"><c:if test="${o.sampleList[2].result1Type==0}">${o.sampleList[2].result1_str}</c:if><c:if test="${o.sampleList[2].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[2].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[2].doubleTmer == true}">(${o.sampleList[2].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 3}"><c:if test="${o.sampleList[3].result1Type==0}">${o.sampleList[3].result1_str}</c:if><c:if test="${o.sampleList[3].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[3].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[3].doubleTmer == true}">(${o.sampleList[3].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 4}"><c:if test="${o.sampleList[4].result1Type==0}">${o.sampleList[4].result1_str}</c:if><c:if test="${o.sampleList[4].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[4].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[4].doubleTmer == true}">(${o.sampleList[4].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 5}"><c:if test="${o.sampleList[5].result1Type==0}">${o.sampleList[5].result1_str}</c:if><c:if test="${o.sampleList[5].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[5].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[5].doubleTmer == true}">(${o.sampleList[5].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 6}"><c:if test="${o.sampleList[6].result1Type==0}">${o.sampleList[6].result1_str}</c:if><c:if test="${o.sampleList[6].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[6].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[6].doubleTmer == true}">(${o.sampleList[6].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 7}"><c:if test="${o.sampleList[7].result1Type==0}">${o.sampleList[7].result1_str}</c:if><c:if test="${o.sampleList[7].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[7].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[7].doubleTmer == true}">(${o.sampleList[7].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 8}"><c:if test="${o.sampleList[8].result1Type==0}">${o.sampleList[8].result1_str}</c:if><c:if test="${o.sampleList[8].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[8].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[8].doubleTmer == true}">(${o.sampleList[8].doubleTmerName})</c:if></c:if></td>
					<td><c:if test="${fn:length(o.sampleList) > 9}"><c:if test="${o.sampleList[9].result1Type==0}">${o.sampleList[9].result1_str}</c:if><c:if test="${o.sampleList[9].result1Type==1}">断柱</c:if><c:if test="${o.sampleList[9].result1Type==2}">超差</c:if><c:if test="${o.sampleList[0].result1Type==3}">损坏</c:if><c:if test="${o.sampleList[9].doubleTmer == true}">(${o.sampleList[9].doubleTmerName})</c:if></c:if></td>
				</tr>
